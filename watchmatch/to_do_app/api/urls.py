...
from to_do_app.api.views import MovieView, MovieViewDetail,WatchViewList,WatchDetailView,StreamViewList,StreamDetailView,ReviewList,ReviewDetail,ReviewCreate,StreamPlatformVS,UserReview
...
urlpatterns = [
    ...
    path("watch/<str:name>",UserReview.as_view(),name="user-review-list")
]